export const API = {
  ...
  EDIT_LABELS: (issueId: number) => `/api/issues/${issueId}/labels`,
  EDIT_ASSIGNEES: (issueId: number) => `/api/issues/${issueId}/assignees`,
  EDIT_MILESTONE: (issueId: number) => `/api/issues/${issueId}/milestones`,
