...
[[change-issue-contents]]
=== 🔒 이슈 내용 변경
operation::change-issue-contents[snippets='http-request,path-parameters,request-fields,http-response']

[[change-issue-milestone]]
=== 🔒 이슈 마일스톤 변경
operation::change-issue-milestone[snippets='http-request,path-parameters,request-fields,http-response']
