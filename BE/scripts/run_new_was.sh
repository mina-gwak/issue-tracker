...
nohup java -jar -Dspring.profiles.active=prod -Dserver.port=${SWITCH_PORT} /home/ec2-user/issueTracker-deploy/build/libs/* > /home/ec2-user/nohup${CURRENT_PORT}.out 2>&1 &
